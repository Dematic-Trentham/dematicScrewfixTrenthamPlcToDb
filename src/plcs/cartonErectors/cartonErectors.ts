...
//Last modified: 2024/03/16 11:06:59
//Version: 1.0.0
...
async function getAndInsertFaultsForErectors() {
  try {
    ...
    //new carton erector
    tryCatchSimple.Promise(() => newCartonErector.getAndInsertFaults("10.4.2.164", "cartonErector", 5), "Carton Erector 5 - Fault or Count Error");
  } catch (err) {
